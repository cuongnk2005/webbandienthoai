  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="side-bar bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <ul class="list">
          <li id="test">
            <a href="<?php echo _WEB_ROOT_ ?>/admin/Dashboard/index"
              class="list-group-item list-group-item-action active  "> Trang chủ <i
          ...
          <li>
            <a href="<?php echo _WEB_ROOT_ ?>/admin/Dashboard/admin_manager_recipt"
          ...
          <li>
            <a href="<?php echo _WEB_ROOT_ ?>/admin/Dashboard/admin_cancel_reciept"
              class="list-group-item list-group-item-action "> Đơn
              hàng bị hủy <i class="menu-icon fas fa-phone-slash"></i></a>
          </li>
          <li>
            <a href="<?php echo _WEB_ROOT_ ?>/admin/Dashboard/feedback" class="list-group-item list-group-item-action">
