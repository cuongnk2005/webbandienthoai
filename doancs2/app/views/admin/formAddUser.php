...
<body>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <div class="container mt-4 ">
          <h2 style="text-align: center; margin-right: 30px;">Thêm User</h2>
          <div class="row">
            <div class="col-6 space-top">
              ...
              <div class="input-group mb-2">
                ...
                <input type="text" id="inputname" class="form-control py-4" value="" placeholder="Nhập tên tài khoản">
              </div>
            </div>
            <div class="col-6 space-top">
              ...
              <div class="input-group mb-2">
                ...
                <input type="text" id="inputmk" class="form-control py-4" value="" placeholder="Nhập mật khẩu">
              </div>
            </div>
            <div class="col-6 space-top">
              ...
              <div class="input-group mb-2">
                ...
                <input type="number" id="inputsdt" class="form-control py-4" value="" placeholder="Nhập số điện thoại">
            ...
            <div class="col-6 space-top">
              ...
              <div class="input-group mb-2">
                ...
                <input type="text" id="inputEmail" class="form-control py-4" value="" placeholder="Nhập email">
              </div>
            </div>
            <div class="col-12 space-top">
              ...
              <div class="input-group mb-2">
                ...
                <input type="text" id="inputDiachi" class="form-control py-4" value="" placeholder="Nhập địa chỉ">
              </div>
            </div>
          </div>
          <div class="row" style="margin-top: 60px;">
            <input id="btnaddUser" header="<?php echo _WEB_ROOT_ ?>"
              class="btn btn-primary col-sm-3 row space-top space-bottom " value="Thêm User">
          </div>
  ...
  <!-- /#wrapper -->
  <!-- Modal -->
  <div class="modal fade" id='model-error' tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal fade" id='model-announce' tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
        ...
        if (errors.length > 0) {
          ...
          $('#btnacceptAdd').on('click', function () {
            ...
            $.ajax({
              ...
              method: "POST",
              url: '<?php echo _WEB_ROOT_ ?>' + '/admin/AdminUser/addUser',
              data: formdata,
              processData: false,
              contentType: false,
            })
